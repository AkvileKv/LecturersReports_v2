...
document.getElementById("planuota4").addEventListener('change', calcTable2);
document.getElementById("atlikta4").addEventListener('change', calcTable2); 

document.getElementById("srautaisPlan").addEventListener('change', calcTable2); 
document.getElementById("srautaisAtl").addEventListener('change', calcTable2); 
document.getElementById("uzsienioPlan").addEventListener('change', calcTable2); 
document.getElementById("uzsienioAtl").addEventListener('change', calcTable2);
