    ...
    User.findById(req.user.id, function(err, foundUser) {
      if (err) {
        ...
        if (foundUser) {
          ...
          for (let i = 1; i <= parseInt(req.body.yonder30); i++) {
          ...
          for (let i = 1; i <= parseInt(req.body.yonder32); i++) {
          ...
          for (let i = 1; i <= parseInt(req.body.yonder34); i++) {
            foundUser.destytojas.tMTEP3_T06.push({
              nr: (tMTEP3_T06nrcommand + i),
              autorius: (tMTEP3_T06autoriuscommand + i),
              menoSrit: (tMTEP3_T06menoSritcommand + i),
              pobudis: (tMTEP3_T06pobudiscommand + i),
              realizVieta: (tMTEP3_T06realizVietacommand + i),
              data: (tMTEP3_T06datacommand + i),
              atlygArNe: (tMTEP3_T06atlygArNecommand + i)
            })
          } // 16 lentelė create
          for (let i = 1; i <= parseInt(req.body.yonder36); i++) {
            foundUser.destytojas.tMTEP3_T07.push({
              nr: (tMTEP3_T07nrcommand + i),
              menoSrit: (tMTEP3_T07menoSritcommand + i),
              pavadinimas: (tMTEP3_T07pavadinimascommand + i),
              atlikVieta: (tMTEP3_T07atlikVietacommand + i),
              data: (tMTEP3_T07datacommand + i),
              atlygArNe: (tMTEP3_T07atlygArNecommand + i)
            })
          }
          //BAIGTA
