...
let options = {
  ...
  ignore: ["destytojas", "katedrosVedejas", "salt", "hash"], // List of fields to ignore when compare changes
...
var optionsMongooseHistory = {diffOnly: true};

userSchema.plugin(passportLocalMongoose);
userSchema.plugin(mongooseHistoryPlugin(options));
userSchema.plugin(mongooseHistory, optionsMongooseHistory);
